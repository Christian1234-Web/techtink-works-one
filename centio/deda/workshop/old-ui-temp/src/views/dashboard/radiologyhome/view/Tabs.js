...
import { ChevronDown, User, Plus, Lock   } from 'react-feather'
                    ...
                    <Nav pills className='mb-2'>
                        <NavItem>
                            <NavLink active={active === '1'} onClick={() => toggleTab('1')}>
                                ...
                                <span className='fw-bold'>Radiology Queue</span>
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink active={active === '2'} onClick={() => toggleTab('2')}>
                                <Lock className='font-medium-3 me-50' />
                                <span className='fw-bold'>Radiology Request</span>
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink active={active === '3'} onClick={() => toggleTab('3')}>
                                <Plus className='font-medium-3 me-50' />
                                <span className='fw-bold'>New Radiology Request</span>
                            </NavLink>
                        </NavItem>
                    </Nav>
