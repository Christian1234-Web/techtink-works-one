...
const InvoiceEditCard = ({ data }) => {
  ...
  const [picker, setPicker] = useState(new Date(data.invoice.updated_at))
  const [dueDatepicker, setDueDatePicker] = useState(new Date(data.invoice.last_appointment_date))
      ...
      <CardBody className='invoice-padding pt-0'>
        <Row className='invoice-spacing'>
          <Col className='p-0' xl='8'>
            ...
            <h6 className='mb-25'>{data.invoice.surname}{ data.invoice.other_names}</h6>
            <CardText className='mb-25'>{data.invoice.hmo.hmoType.name}</CardText>
            <CardText className='mb-25'>{data.invoice.address}</CardText>
            <CardText className='mb-25'>{data.invoice.phone_number}</CardText>
            <CardText className='mb-0'>{data.invoice.email}</CardText>
          </Col>
