...
import NavdataOptometrist from "./OptometristMenuData";
import NavdataOptician from "./OpticianMenuData";
...
const SidebarContent = (props) => {
    ...
    const NavdataOpticians = NavdataOptician().props.children;
    const NavdataOptometrists = NavdataOptometrist().props.children;
    ...
    return (
        <React.Fragment>
            {/* menu Items */}
            {(user_type === 'facility' ? navData : user_type === 'optician' || user_type === 'training' ?
                NavdataOpticians : user_type === 'optometrist' || user_type === 'internship' ? NavdataOptometrists : []).map((item, key) => {
                    return (
