...
import {
    Card, CardBody, Col, Container, DropdownItem, DropdownMenu, DropdownToggle, Input, Label, Nav, NavItem, NavLink, Row,
    Modal, ModalBody, ModalFooter, ModalHeader, TabContent, Table, TabPane, UncontrolledDropdown
} from 'reactstrap';
...
import UpdateLogTrainingOptician from '../UpdateLogTrainingOptician';
import { audioAac } from '@cloudinary/url-gen/qualifiers/format';
...
const SimplePage = () => {
    ...
    let [optician_countdown] = store.optician_countdown;
    ...
    const [, setSelected_lga] = useState('');
                        ...
                        <Col lg={12}>
                            <div>
                                ...
                                <TabContent activeTab={activeTab} className="pt-4">
                                    ...
                                    <TabPane tabId="4">
                                        <UpdateLogTrainingOptician user={aUser} training={opticianTraining} optician={aUser?.optician} />
                                    </TabPane>
                                    <TabPane tabId="5">
                                        <Comment
                                            user={aUser}
