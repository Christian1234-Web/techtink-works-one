...
function RegisteredOptometrist() {
                ...
                <tr key={i}>
                    ...
                    <td>
                        <div className="hstack flex-wrap">
                            ...
                            <Link to={`/admin-registered-op/${`optometrist`}/${e.id}`} className="link-success btn-icon btn-sm" id="Tooltip3"><i className="ri-compass-3-line fs-16"></i></Link>
        ...
        <>
            <Container fluid>
                <div className="page-content">
                    ...
                    <div className='mt-4'>
                        <BreadCrumb title="Registered  Optometrists" pageTitle="Admin" />
...
export default RegisteredOptometrist;