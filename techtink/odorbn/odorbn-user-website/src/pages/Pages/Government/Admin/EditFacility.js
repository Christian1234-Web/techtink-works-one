...
import { Card, CardBody, Col, Form, Nav, NavItem, NavLink, TabContent, Label, TabPane, ListGroupItem, Button, ListGroup, Row, Input, Container } from "reactstrap";
import { request } from '../../../../services/utilities';
import { Link, useHistory, useParams } from 'react-router-dom';
import RepeatingForm from '../RegForm/RepeatingForm';
import RepeatingFacility from '../RegForm/RepeatingFacility';
...
function EditFacility() {
    ...
    const [read_only] = useState(false);
    ...
    const updatePractice = async () => {
        ...
        try {
            ...
            setLoading(false);
            if (rs.success === true) {
                history.push(`${typeRoute.type}-facility`);
                setFiles([]);
                handleUpdate();
            }
        }
    ...
    const refreshUpdate = useCallback(async (state) => {
        setLoading(true);
    ...
    useEffect(() => {
        ...
        fetchStates();
        refreshUpdate();
    }, [refreshUpdate, fetchTypeOfPractice, fetchStates])
                                                    ...
                                                    <div>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <div className="hstack gap-3 flex-wrap">
                                                                                                                    <Link className="link-success fs-15"><i onClick={() => editDirectorFacility(i)} className="ri-edit-2-line"></i></Link>
                                                                                                                    <Link className="link-danger fs-15"><i
                                                                                                ...
                                                                                                return (
                                                                                                    <tbody key={i}>
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <div className="hstack gap-3 flex-wrap">
                                                                                                                    <Link className="link-success fs-15"><i onClick={() => editFacilityPractice(i)} className="ri-edit-2-line"></i></Link>
                                                                                                                    <Link className="link-danger fs-15"><i
                                                        ...
                                                        <div className="d-flex align-items-start gap-3 mt-4">
                                                            <div className="text-end">
                                                                <Link to={`/${typeRoute.type}-facility`}>
