                ...
                <tr key={i}>
                    ...
                    <td>
                        <div className="hstack flex-wrap">
                            ...
                            <Link to={`/admin-approved-it/${`internship`}/${e.id}`} className="link-success btn-icon btn-sm" id="Tooltip3"><i className="ri-compass-3-line fs-16"></i></Link>
                        </div>
            ...
            return (
                <tr key={i}>
                    ...
                    <td>
                        <div className="hstack flex-wrap">
                            <Badge color="success" style={{ cursor: 'pointer' }} onClick={() => enableEdit(e.id)}> Enable </Badge>
                            <Link to={`/admin-approved-if/${`internship`}/${e.id}`} className="link-success btn-icon btn-sm" id="Tooltip3"><i className="ri-compass-3-line fs-16"></i></Link>
        ...
        <>
            <Container fluid>
                <div className="page-content">
                    ...
                    <div className='mt-4'>
                        <BreadCrumb title="Approved  Internships" pageTitle="Admin" />
                    ...
                    <div className="col-xl-12">
                        <div className="card">
                            <div className="card-header align-items-center d-flex">
                                <h4 className="card-title mb-0 flex-grow-1">Approved Internships</h4>
