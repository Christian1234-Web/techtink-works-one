                ...
                <tr key={i}>
                    ...
                    <td>
                        <div className="hstack  flex-wrap">
                            ...
                            <Link to={`/admin-registered-it/${`training`}/${e.id}`} className="link-success btn-icon btn-sm" id="Tooltip3"><i className="ri-compass-3-line fs-16"></i></Link>
                        </div>
            ...
            return (
                <tr key={i}>
                    ...
                    <td>
                        <div className="hstack flex-wrap">
                            <Badge color="success" style={{ cursor: 'pointer' }} onClick={() => enableEdit(e.id)}> Enable </Badge>
                            <Link to={`/admin-registered-if/${`training`}/${e.id}`} className="link-success btn-icon btn-sm" id="Tooltip3"><i className="ri-compass-3-line fs-16"></i></Link>
                        </div>
                        <UncontrolledTooltip placement="top" target="Tooltip3">View Details  </UncontrolledTooltip>
                    </td>
                </tr>
        ...
        <>
            <Container fluid>
                <div className="page-content">
                    ...
                    <div className='mt-4'>
                        <BreadCrumb title="Registered  Supervised Ophthalmic Laboratory Experience" pageTitle="Admin" />

                    </div>
                    <div className="col-xl-12">
                        <div className="card">
                            <div className="card-header align-items-center d-flex">
                                <h4 className="card-title mb-0 flex-grow-1">Registered  Supervised Ophthalmic Laboratory Experience</h4>
