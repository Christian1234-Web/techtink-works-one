...
import { Modal, Button, Badge, ModalHeader, ModalBody, ModalFooter, Nav, UncontrolledTooltip, Col, TabContent, TabPane, NavItem, NavLink, Table, Container } from 'reactstrap';
import Swal from 'sweetalert2';
import withReactContent from 'sweetalert2-react-content';
import OptometristInternship from './RegisteredInternship';
const MySwal = withReactContent(Swal);

// import {Loa}

function ApprovedOptometrist() {
    ...
    const enableEdit = async (id) => {
        const data = { type: 'optometrist', id };
        try {
                ...
                <tr key={i}>
                    ...
                    <td>
                        <div className="hstack flex-wrap">
                            ...
                            <Link to={`/admin-approved-op/${`optometrist`}/${e.id}`} className="link-success btn-icon btn-sm" id="Tooltip3"><i className="ri-compass-3-line fs-16"></i></Link>
        ...
        <>
            <Container fluid>
                <div className="page-content">
                    ...
                    <div className='mt-4'>
                        <BreadCrumb title="Approved  Optometrists" pageTitle="Admin" />

                    </div>
                    <div className="col-xl-12">
                        <div className="card">
                            <div className="card-header align-items-center d-flex">
                                <h4 className="card-title mb-0 flex-grow-1">Approved Optometrists </h4>
...
export default ApprovedOptometrist;