                ...
                <tr key={i}>
                    ...
                    <td>
                        <div className="hstack flex-wrap">
                            ...
                            <Link to={`/admin-approved-op/${`optician`}/${e.id}`} className="link-success btn-icon btn-sm" id="Tooltip3"><i className="ri-compass-3-line fs-16"></i></Link>
        ...
        <>
            <Container fluid>
                <div className="page-content">
                    ...
                    <div className='mt-4'>
                        <BreadCrumb title="Approved Opticians" pageTitle="Admin" />
                        ...
                        <div className="col-xl-12">
                            <div className="card">
                                <div className="card-header align-items-center d-flex">
                                    <h4 className="card-title mb-0 flex-grow-1">Approved Opticians </h4>
...
export default RegisteredOptician;