                ...
                <div className="p-4 pb-0">
                    ...
                    <SimpleBar className="message-list-content mx-n4 px-4 message-list-scroll">
                        <ul className="message-list">
                            {messages?.length < 1 || messages?.internship === null ? '' : <li className='' onClick={() => showMessage(messages?.internship)}>
                                ...
                                <div className="col-mail col-mail-2">
                                    <Link to="#" className="subject text-capitalize"> {<span className={"badge me-2 bg-"}></span>} <span className="teaser text-capitalize">{`Internship ID:`} {messages?.internship?.id}<span className='text-success fs-50 text-lowercase' to='#'>see more</span></span>
                                    </Link>
                                    <div className="date">{new Date(messages?.internship?.createdAt).toLocaleDateString()}</div>
                                </div>
                            </li>}

                            {messages?.length < 1 || messages?.optometrist === null ? '' : <li className='' onClick={() => showMessage(messages?.optometrist)}>
                                <div className="col-mail col-mail-1">
                                    {/* <div className="form-check checkbox-wrapper-mail fs-14">
                                                <input className="form-check-input" type="checkbox" value="" id={item.forId} />
                                                <label className="form-check-label" htmlFor={item.forId}></label>
                                ...
                                <div className="col-mail col-mail-2" >
                                    <Link to="#" className="subject text-capitalize"> {<span className={"badge me-2 bg-"}></span>} <span className="teaser text-capitalize">{`Optician ID:`} {messages?.optometrist?.id} <span className='text-success fs-50 text-lowercase' to='#'>see more</span></span>
                                    </Link>
