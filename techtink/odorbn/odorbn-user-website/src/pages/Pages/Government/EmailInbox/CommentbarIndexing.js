                ...
                <div className="p-4 pb-0">
                    ...
                    <SimpleBar className="message-list-content mx-n4 px-4 message-list-scroll">
                        <ul className="message-list">
                            ...
                            <li className='' onClick={() => showMessage(messages.indexing)}>
                                ...
                                <div className="col-mail col-mail-2" >
                                    <Link to="#" className="subject text-capitalize"> {<span className={"badge me-2 bg-"}></span>} <span className="teaser text-capitalize">{`Indexing`} Id:{messages?.indexing?.id} <span className='text-success fs-50 text-lowercase' to='#'>see more</span></span>
                                    </Link>
