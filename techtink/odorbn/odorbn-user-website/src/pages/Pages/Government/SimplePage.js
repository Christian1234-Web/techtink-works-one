...
import { Card, CardBody, Col, Container, Modal, ModalBody, ModalHeader, ModalFooter, Button, DropdownItem, DropdownMenu, DropdownToggle, Input, Label, Nav, NavItem, NavLink, Row, TabContent, Table, TabPane, UncontrolledDropdown } from 'reactstrap';
...
import UpdateLogFacility from './UpdateLogFacility';
    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <MetaTags>
                    <title>Profile | Dashboard | ODORBN</title>
                </MetaTags>
                        ...
                        <Col lg={12}>
                            <div>
                                ...
                                <TabContent activeTab={activeTab} className="pt-4">
                                                            ...
                                                            <Table className="table-borderless mb-0">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td className="text-muted">{aUser.addressOrigin}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                            ...
                                            <Col xxl={9}>
                                                <div className="col-xl-12">
                                                    <div className="card bg-primary">
                                                        <div className="card-body p-0">
                                                            <div className="alert alert-danger rounded-top alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" role="alert">
                                                                ...
                                                                <div className="flex-shrink-0">
                                                                    <Link to='/new-facility' className="text-reset text-decoration-underline"
                                                                    ><b>New Facility</b></Link>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <Facilty
                                                        practices={practices}
                                                        error={error}
                                                        showEditFacility={() => console.log('err')}
                                                        idx={idx}
                                    ...
                                    <TabPane tabId="4">
                                        <UpdateLogFacility user={aUser} practices={practices} />
                                    </TabPane>
                                    <TabPane tabId="5">
                                        <Comment user={aUser} />
                                    </TabPane>
